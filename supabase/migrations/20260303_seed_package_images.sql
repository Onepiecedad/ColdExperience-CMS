...
UPDATE cms_packages
SET image_url = 'https://images.unsplash.com/photo-1517411032315-54ef2cb783bb?auto=format&fit=crop&w=1200&q=80'
WHERE package_key = 'complete';

UPDATE cms_packages
SET image_url = 'https://images.unsplash.com/photo-1507272931001-fc06c17e4f43?auto=format&fit=crop&w=1200&q=80'
WHERE package_key = 'adventure';

UPDATE cms_packages
SET image_url = 'https://images.unsplash.com/photo-1454496522488-7a8e488e8606?auto=format&fit=crop&w=1200&q=80'
WHERE package_key = 'threeDay';

UPDATE cms_packages
SET image_url = 'https://images.unsplash.com/photo-1705946985442-512875aaa310?auto=format&fit=crop&w=1200&q=80'
...
VALUES
  ...
  ('packages', 'package1day', 'packages.taster.image',    'url',
   'https://images.unsplash.com/photo-1705946985442-512875aaa310?auto=format&fit=crop&w=1200&q=80',
   'https://images.unsplash.com/photo-1705946985442-512875aaa310?auto=format&fit=crop&w=1200&q=80',
   'https://images.unsplash.com/photo-1705946985442-512875aaa310?auto=format&fit=crop&w=1200&q=80',
   'https://images.unsplash.com/photo-1705946985442-512875aaa310?auto=format&fit=crop&w=1200&q=80')
